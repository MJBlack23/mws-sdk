...
class MWS {
  ...
  constructor(config = undefined) {
    ...
    MWS.formatQuery = MWS.formatQuery.bind(this);
    MWS.XMLToJSON = MWS.XMLToJSON.bind(this);
   ...
   */
  async makeCall(params, resolveWithFullResponse = false) {
    const call = {
  ...
  parseEnv() {
    ...
    this.host = MWS_HOST || 'mws.amazonservices.com';
  ...
  static async XMLToJSON(xml, opts = {}) {
    const xmlOptions = { ...this.xml_options, ...opts };
    return parseString(xml, xmlOptions);
  }
} // end MWS Class
